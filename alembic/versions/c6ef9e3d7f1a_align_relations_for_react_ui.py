...
down_revision: Union[str, Sequence[str], None] = '44bda881d613'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('nutrient_type_id', 'name', name='uq_nutrient_name_type_name'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('product_id', 'nutrient_name_id', name='uq_product_nutrient'),
    )
